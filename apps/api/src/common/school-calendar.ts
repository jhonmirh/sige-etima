 ...
 * del año calendario en el que inicia el período escolar.
 */
...
export function automaticEnrollmentCloseDate(startDate: Date | string): Date {
  ...
  // 00:00 en Venezuela = 04:00 UTC. De esta forma el cambio ocurre exactamente
  // al comenzar el 31 de octubre en la zona horaria institucional.
