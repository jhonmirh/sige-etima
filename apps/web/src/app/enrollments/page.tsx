...
export default function Enrollments(){
  ...
  const closeReached=!!year?.enrollmentCloseDate && new Date().toISOString().slice(0,10)>=isoDay(year.enrollmentCloseDate);
